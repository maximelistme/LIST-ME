function showPage(p) {
    ...
    if(p === 'calendar') if(typeof renderCalendar === "function") renderCalendar(); 
    if(p === 'todo') if(typeof renderTodo === "function") renderTodo(); 
    if(p === 'tasks') if(typeof renderTasks === "function") renderTasks();
    if(p === 'shopping') { 
